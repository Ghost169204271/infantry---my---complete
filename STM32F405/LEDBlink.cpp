...
Motor can1_motor[5] = {
	...
	Motor(M6020,POS,yawMotor,  ID5, PID(80.f, 0.1f, 20.f,0.f),
									PID(0.1f, 0.f, 2.f,0.f)),
						};
...
Motor can2_motor[4] = {
	...
	//								PID(0.f,0.f,0.f,0.f)),
	Motor(M6020,POS,pitchMotor, ID4, PID( 80.f, 0.1f, 20.f,0.f),
									PID( 0.8f, 0.f, 16.f,0.f)),
						};
...
void OnUSBRecive()
{
	memcpy(&nuc.data, nuc.rxData, sizeof(NUC::datapack));
	nuc.daimx = nuc.data.x;
	nuc.daimy = nuc.data.y;
	nuc.aimratio = nuc.data.a;
}
...
int main(void)
{
	...
	//uart1.Init(USART1, 115200).DMATxInit().DMARxInit(nuc.GetDMARx());
	uart2.Init(USART2, 100000).DMARxInit(rc.GetDMARx());	
	uart5.Init(UART5, 115200).DMARxInit(imu_pantile.GetDMARx());
	//uart5.Init(UART5, 115200).DMARxInit(imu.GetDMARx());
	//uart6.Init(USART6, 115200).DMATxInit().DMARxInit(judgement.GetDMARx(), 99);
	/*
