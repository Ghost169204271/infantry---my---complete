...
void Judgement::OnIRQHandler(const size_t readnum)
{
	m_readnum = readnum;
...
void Judgement::Gragh_Top(void)
{
	...
	if (data.ext_game_robot_status_t.robot_id > 10)
		CommunatianData_top.dataFrameHeader.receiver_ID = id_blue;
	else
		CommunatianData_top.dataFrameHeader.receiver_ID = id_red;
...
void Judgement::Gragh_Aim(void)
{
	...
	if (data.ext_game_robot_status_t.robot_id > 10)
		CommunatianData_aim.dataFrameHeader.receiver_ID = id_blue;
	else
		CommunatianData_aim.dataFrameHeader.receiver_ID = id_red;
...
void Judgement::Gragh_X(void)
{
	...
	if (data.ext_game_robot_status_t.robot_id > 10)
		CommunatianData_x.dataFrameHeader.receiver_ID = id_blue;
	else
		CommunatianData_x.dataFrameHeader.receiver_ID = id_red;
...
void Judgement::Gragh_Lock(void)
{
	...
	if (data.ext_game_robot_status_t.robot_id > 10)
		CommunatianData_lock.dataFrameHeader.receiver_ID = id_blue;
	else
		CommunatianData_lock.dataFrameHeader.receiver_ID = id_red;
...
void Judgement::Gragh_Line(void)
{
	...
	if (data.ext_game_robot_status_t.robot_id > 10)
		CommunatianData.dataFrameHeader.receiver_ID = id_blue;
	else
		CommunatianData.dataFrameHeader.receiver_ID = id_red;
